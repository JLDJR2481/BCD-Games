...
from .views import RootView, UserLoginView, UserLogoutView, UserRegisterView, UserUpdateView, UserVerifyView, ForgotPasswordEmailView, VerifyForgotPasswordView, ResetPasswordView
